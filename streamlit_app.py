...
def show_dashboard(ml_pipeline):
...
def show_model_info(ml_pipeline):
    ...
    performance_data = {
        ...
        'Algorithm': ['Logistic Regression', 'XGBoost', 'Logistic Regression'],
        'AUC Score': [0.9805, 0.9992, 0.9864],
        'Accuracy': ['98%', '99%', '99%']
    }
